...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let Prak = `🧿 *Respeta las reglas de PrakBot*\n
☠︎︎ No llamar Al Bot
☠︎︎ No hacer spam
☠︎︎ Contacta al creador si es necesario
☠︎︎ Pedir permiso para añadir al bot a un grupo

🚀 𝗡𝗼𝘁𝗮: *Si no cumples con las reglas del bot, seras bloqueado.*

🚀 𝗔𝘃𝗶𝘀𝗼: *Puedes apoyarnos dejando una estrellita 🌟 al repositorio oficial de PrakBot: ${repobot}*
